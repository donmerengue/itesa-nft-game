...
const Sidebar = () => {
  return (
    <>
      <aside
        id="sidebar"
        className="z-20 h-full  flex lg:flex  flex-col w-64 transition-width duration-75"
        aria-label="Sidebar"
      >
        <div className="relative flex-1 flex flex-col  border-r border-gray-200 bg-white ">
          <div className="flex-1 flex flex-col pt-5 pb-4  overflow-y-auto">
            <div className="flex-1 px-3 bg-white divide-y space-y-1">
              <ul className="fixed space-y-2 pb-2">
                <li>
                ...
                <li>
                  <Link href="/admin/tokenBalance">
                    <a className="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-orange-100 group">
                      ...
                      <span className="ml-3">Token Balance</span>
                    </a>
                  </Link>
                </li>
                <li>
                  <Link href="/admin/gameConfig">
                    <a className="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-orange-100 group">
                      <svg
                        className="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75"
                        fillRule="currentColor"
                      ...
                      <span className="ml-3">Game Config</span>
                    </a>
                  </Link>
                </li>
